      ...
      <AppBar sx={{ boxShadow: 'none', position: 'absolute', top: mobileSize ? '65px' : '100px', background: 'white', border: '1px solid #eaeaea', zIndex: 1 }}>
        <Container>
          <Grid display={'flex'} >
            ...
            <Button sx={{ color: '#333f48', ':hover': { background: 'none' } }} variant='standard' startIcon={<Tune />} onClick={handleOpenFilter}>Filters</Button>
          </Grid>
        </Container>
        <Drawer
          open={openFilter}
        ...
        >
          <Container>
            <List>
              <ListItem>
                <Grid container sx={{ display: 'flex', justifyContent: mobileSize ? 'center' : 'start' }}>
              ...
              <ListItem sx={{ display: 'flex', justifyContent: mobileSize ? 'center' : 'start' }}>
