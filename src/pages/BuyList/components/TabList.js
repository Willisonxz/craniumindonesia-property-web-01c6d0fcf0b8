...
import locationLogo from "../assets/Location Logo Black.png"
            ...
            <div className='d-flex justify-content-sm-between flex-lg-row flex-xs-column flex-sm-column col-sm-12'>
                <div className='d-flex flex-column left-box-bl'>
                    <div className='d-flex justify-content-between'>
                        ...
                        <IconButton type="button" sx={{ p: '10px' }} className='bt-save pointer' aria-label="search" onClick={(e)=>navigate("/buy/save-search")}>
                    ...
                    <div className='d-flex justify-content-between col-sm-12 col-xs-12'>
                        <div className='d-flex '>
                            ...
                            <div className='d-flex list-bl' onClick={(e)=>navigate("/buy/map")}>
                                <IconButton type="button" sx={{ p: '10px' }} className={`${path==="/buy/map"?"selected":""}`} aria-label="search">
                                    <img src={locationLogo} alt='' style={{marginRight:"5px"}} className='list-16'/>
