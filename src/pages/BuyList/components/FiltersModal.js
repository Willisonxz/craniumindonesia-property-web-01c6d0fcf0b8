    ...
    <div className='modal-background' style={{height:`${height}px`}}>
      ...
      <div className='box-modal' >
        <div className='sc-modal'>
            <div className='col-sm-12 d-flex flex-column justify-content-center searchBar-buylist'> 
            <Grid width={"100%"} className='bg-ff col-12'>
          ...
          <div className='filters-tab'  style={{ width: '100%', height: '61px' }}>
            <Tabs value={value}  aria-label="basic tabs example">
              <Tab label="Buy" {...a11yProps(0)} onClick={(e)=>setValue(0)}  />
              <Tab label="Rent" {...a11yProps(1)} onClick={(e)=>setValue(1)}  />
              <Tab label="Sold"  {...a11yProps(2)} onClick={(e)=>setValue(2)}  />
            </Tabs>
          </div>
          {value===0 &&
