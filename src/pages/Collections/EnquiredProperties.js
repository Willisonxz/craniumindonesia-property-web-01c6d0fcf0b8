                    ...
                    <div className="box-content-collections">
                        <div className="row mx-0 px-0 my-2 gy-2 gx-4">
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 px-0" >
                                ...
                                <Typography fontSize={"34px"} fontWeight={"700"}>My Enquired Properties</Typography>
                                </div>
                            </div>
                        </div>

                        <Box sx={{ my: 3 }} height='300px' position='relative'>
                            <Maps style={{
                                borderRadius: '1rem',
                                overflow: 'hidden',
                                margin: 0,
                        ...
                        <div className="row mx-0 px-0 my-2 gy-4 gx-4">
                            <div className="center-container">
                                <div className="center-content" style={{ padding: "10rem" }}>
                                    ...
                                    <div>
                                        <Typography fontSize={"18px"}>Keep track of the properties you've sent email enquires about here</Typography>
                                    </div>
                                </div>
                            </div>
                        </div>
