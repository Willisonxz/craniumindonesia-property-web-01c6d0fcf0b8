...
export default function OrganisingCleaning() {
    ...
    const breadcrumbs = [
        <button className="nav-link" key="1" style={{ color: "grey" }} textDecoration='none' onClick={() => navigate(RoutesPage.RouteLifeStyle)}>
            Life Style
        </button>,
        <Typography key="3" style={{ color: "grey" }}>
            Organising & Cleaning
        </Typography>,
    ];
            ...
            <div className='box-content' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <div className="center " style={{
                    ...
                    <p style={{
                        ...
                        ay goodbye to disorganisation and mess forever. Here you'll find easy house cleaning hacks and storage solutions for every space, discover how to declutter, and unearth time-saving organisation tips that will save your sanity.  
                    </p>
                </div>
