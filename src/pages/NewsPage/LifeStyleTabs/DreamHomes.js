...
export default function DreamHomes() {
            ...
            <div className='box-content' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <div className="center " style={{
                    ...
                    <p style={{
                        ...
                        Look inside award-winning dream homes, discover architectural masterpieces in incredible locations, find quirky homes in offbeat places, and uncover interior design and decorating secrets that can make your dream house look a million dollars too.  
                    </p>
                </div>
