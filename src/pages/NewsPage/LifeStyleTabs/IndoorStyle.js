...
import SubTabsLifeStyle from "../../NewsPage/components/SubTabsLifeStyle";
...
export default function IndoorStyle() {
        ...
        <div>
            ...
            <div className='box-content' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <div className="center " style={{
                    ...
                    marginBottom: "30px",
                    backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_400,h_300/v1657671265/news-lifestyle-content-assets/wp-content/production/ujitsu-Option-1_733297301f5.png?_i=AA)`,
                }}>
                    <div className="m-2">
                    ...
                    <p style={{
                        ...
                        Get all the latest news and updates on sustainable and eco-friendly houses around Australia and the world. From the best and most unique eco homes for sale and sustainable house designs, technology and insights.
                    </p>
                </div>
