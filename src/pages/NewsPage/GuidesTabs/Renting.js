  ...
  return (
    <div>
      ...
      <div className="center object-fit-cover" style={{
        ...
        height: '450px',
        marginTop: 2,
        backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_1400,h_700/v1657815878/news-lifestyle-content-assets/wp-content/production/renting_background1.jpg?_i=AA)`,
      }}>
        <div className="container" style={{ paddingTop: '130px' }}>
          ...
          <p style={{
            ...
            From the initial rental application through to dealing with flatmates, we’ve got you covered. Our how-to guides cover tenants’ rights, how to get a place with your pet, dealing with landlords and easy styling tips that won’t cost you your bond.
          </p>
