  ...
  return (
    <div>
      ...
      <div className="center object-fit-cover" style={{
        ...
        marginTop: 2,
        marginBottom: "30px",
        backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_1400,h_700/v1679010530/news-lifestyle-content-assets/wp-content/production/online-safety.png?_i=AA)`,
      }}>
        <div className="container" style={{ paddingTop: '130px' }}>
          ...
          <p style={{
            ...
            Growth in online scams and real-world dodgy deals mean you need to protect yourself when you’re renting or buying. These handy guides will help you avoid everything from phishing emails to hidden problems with a property.
          </p>
