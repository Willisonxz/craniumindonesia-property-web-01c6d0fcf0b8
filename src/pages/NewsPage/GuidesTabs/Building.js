  ...
  return (
    <div>
      ...
      <div className="center object-fit-cover" style={{
        ...
        height: '450px',
        marginTop: 2,
        backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_1400,h_700/v1660045970/news-lifestyle-content-assets/wp-content/production/BLU0529_ColorbondxREA_Long-Jetty_2000x1000px.png?_i=AA)`,
      }}>
