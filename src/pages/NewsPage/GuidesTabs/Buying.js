  ...
  return (
    <div>
      ...
      <div className="center" style={{
        ...
        height: '450px',
        marginTop: 2,
        backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_1000,h_500/v1669639099/news-lifestyle-content-assets/wp-content/production/hero-buying.jpg?_i=AA)`,
      }}>
        <div className="container" style={{ paddingTop: '130px' }}>
          ...
          <p style={{
            ...
            Buying a first home? Family home? Upsizing or downsizing? What should you look for, and what should you avoid? We have tips and how-to guides on every aspect of buying a property you can call home
          </p>
