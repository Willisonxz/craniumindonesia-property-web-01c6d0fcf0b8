  ...
  return (
    <div>
      ...
      <div className="center object-fit-cover" style={{
        ...
        height: '450px',
        marginTop: 2,
        backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_1400,h_700/v1657815891/news-lifestyle-content-assets/wp-content/production/finance_background.jpg?_i=AA)`,
      }}>
        <div className="container" style={{ paddingTop: '130px' }}>
          ...
          <p style={{
            ...
            A house can’t be yours unless you can pay for it. Whether you’re first home owners, downsizers, or everything in between, find the money-saving tips behind mortgages and home loans, and how to budget and save enough to get one. 
          </p>
