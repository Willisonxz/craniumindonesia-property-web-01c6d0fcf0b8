...
export default function Sustainbility() {
  ...
  return (
    <div>
      ...
      <div className="center object-fit-cover" style={{
        ...
        height: '450px',
        marginTop: 2,
        backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_1400,h_788/v1658123620/news-lifestyle-content-assets/wp-content/production/Solar.6Expert.jpg?_i=AA)`,
      }}>
        <div className="container" style={{ paddingTop: '130px' }}>
          ...
          <p style={{
            ...
            Everything you need to know about sustainable homes, self-sustaining homes, sustainable living and how to be more environmentally friendly.
          </p>
