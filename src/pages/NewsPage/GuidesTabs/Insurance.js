  ...
  return (
    <div>
      ...
      <div className="center object-fit-cover" style={{
        ...
        height: '450px',
        marginTop: 2,
        backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://www.realestate.com.au/news-image/w_1400,h_700/v1661415708/news-lifestyle-content-assets/wp-content/production/kitchen10_354836512a5.jpg?_i=AA)`,
      }}>
        <div className="container" style={{ paddingTop: '130px' }}>
          ...
          <p style={{
            ...
            Contents insurance, building insurance and landlord insurance – whether you’re a first home buyer or a long-standing investor, we have the advice and guides to help you choose the right insurance for you.
          </p>
