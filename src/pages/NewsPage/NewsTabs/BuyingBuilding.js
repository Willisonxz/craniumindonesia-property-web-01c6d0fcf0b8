...
export default function BuyingBuilding() {
      ...
      <div className='box-content' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="center" style={{
          ...
          <p style={{
            ...
            Stay up to date with the latest news and insights on new homes and the property development industry. Hear about new launches and which projects are selling fast.
          </p>
        </div>
