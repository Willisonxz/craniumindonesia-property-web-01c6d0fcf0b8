...
export default function SustainableHome() {
  ...
  const breadcrumbs = [
    <button className="nav-link" key="1" style={{color: "white"}} textDecoration='none' onClick={() => navigate(RoutesPage.RouteNews)}>
      News
    </button>,
