    ...
    <div>
      ...
      <div className='box-content' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="center" style={{
          ...
          marginTop: 2,
          marginBottom: "30px",
          backgroundImage: `linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url(https://dam-assets.au.reastatic.net/images/w_1248,h_700/v1659145236/news-lifestyle-content-assets/wp-content/production/aaa1da66-ce9e-48a0-860e-a6f1fe49fdc2_719194cf0ca/aaa1da66-ce9e-48a0-860e-a6f1fe49fdc2_719194cf0ca.jpeg?_i=AA)`,
        }}>
          <h1 style={{
            color: 'white',
            fontFamily: 'Roboto',
          ...
          <p style={{
            ...
            The Australian property market is constantly changing. Leveraging unparalleled real estate data and behavioural market intelligence the experts at PropTrack unpack what's really happening in real estate.
          </p>
        </div>
