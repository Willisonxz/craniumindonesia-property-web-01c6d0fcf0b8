            ...
            <div className='box-content' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <div className="center" style={{
                    ...
                    <p style={{
                        ...
                        Create your best-ever home in style right here, right now. We bring you lifestyle advice, inspiration and ideas from some of Australia's leading creatives and experts on everything from renovating, DIY and outdoor living to decorating and interior design. Home is where the heart is.
                    </p>
                </div>
