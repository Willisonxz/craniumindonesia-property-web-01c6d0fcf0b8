...
export default function AddSecondIDModal(props) {
        ...
        <DialogContent
         dividers sx={{
          ...
          <div className=''>
              <div className=''>
                  <div className='mb-4'>
                      <Typography gutterBottom display={"block"} className='mb-4'>Include an ID with your name on it, like a utility bill or Medicare card.</Typography>
                      <div className="mb-3">
