...
export default function AddPhotoIDModal(props) {
    ...
    <BootstrapDialog 
      ...
      >
        <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
          <Typography fontSize={"20px"} fontWeight={"700"}>Add a document</Typography>
        ...
        <DialogContent
         dividers sx={{
          ...
          <div className=''>
              <div className=''>
                  <div className='mb-5'>
                      <Typography gutterBottom display={"block"} fontWeight={"700"}>Choose a photo ID</Typography>
                      <TextField
                        size='small'
                  ...
                  <div className='mb-4'>
                      <Typography gutterBottom display={"block"} fontWeight={"700"}>Upload an image</Typography>
                      <Typography gutterBottom display={"block"} fontSize={"12px"} className='text-muted'>Include an image of the front and back of your licence.</Typography>
                      <div>
